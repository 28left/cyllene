...
from .problem_basic import Problem
...
class ParameterProblem(Problem):
    ...
    def set_core_attributes(self):
        ...
        self.instantiated_answer = ""
        self.instantiated_solution = ""
        self.instantiated_dict = {}

    def instantiate_problem(self, externals: dict):
        """
    ...
    #     return_dict["problem_id"] = self.problem_id
    #     return_dict["title"] = self.title
    #     return_dict["statement"] = self.instantiated_statement
    #     return_dict["answer"] = self.instantiated_answer
    #     return_dict["solution"] = self.instantiated_solution
